...
const InventoryOptimization = () => {
  ...
  const ActionBadge = ({ action }) => {
    ...
    return (
      <Badge className="bg-slate-100 text-slate-800 border-slate-200 dark:bg-neutral-850 dark:text-slate-300 dark:border-neutral-800">
  ...
  return (
    <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-slate-50 to-blue-50 dark:from-black dark:to-black">
      <div className="max-w-7xl mx-auto">
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-slate-700 dark:text-white">{maintainCount}</p>
                </div>
        ...
        {/* Going Down Notice */}
        <Card className="mb-8 shadow-lg border-0 bg-white/90 dark:bg-neutral-900/90 backdrop-blur-sm animate-fade-in-up" style={{ animationDelay: '0.22s' }}>
          <CardHeader>
          ...
          <CardContent>
            {goingDown.length === 0 ? (
              ...
              <div className="flex flex-wrap gap-2">
                {goingDown.map(g => (
                  <Badge key={g.product} variant="outline" className="text-sm dark:border-neutral-800">
        ...
        <Card className="mb-8 shadow-lg border-0 bg-gradient-to-br from-blue-50 to-purple-50 dark:from-neutral-900 dark:to-neutral-900 backdrop-blur-sm animate-fade-in-up" style={{ animationDelay: '0.25s' }}>
          <CardHeader>
          ...
          <CardContent className="space-y-4">
            ...
            {decisions.filter(d => d.action === 'Maintain').length > 0 && (
              <div className="bg-slate-50 dark:bg-neutral-950/50 p-4 rounded-lg border border-slate-200 dark:border-neutral-850">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center mb-6 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
          ...
          <div className="flex items-center space-x-2">
            ...
            <Button variant="outline" onClick={exportCsv} className="dark:border-neutral-800 dark:text-white">
        ...
        {/* Decisions Table */}
        <Card className="shadow-2xl border-0 bg-white/90 dark:bg-neutral-900/90 backdrop-blur-sm animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
          <CardHeader className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-neutral-900 dark:to-neutral-900 rounded-t-lg">
            <CardTitle className="flex items-center space-x-2 text-slate-900 dark:text-white">
              ...
              <Badge className="bg-white/80 text-blue-700 border-blue-200 shadow-sm dark:bg-neutral-850 dark:text-blue-300 dark:border-green-800">
                {HORIZON}
              </Badge>
            </CardTitle>
          </CardHeader>
            ...
            {decisions.length === 0 ? (
              ...
              <div className="overflow-x-auto">
                <table className="min-w-full text-sm">
                  ...
                  <tbody>
                    {decisions.map((d) => (
                      <tr key={d.product} className="border-t border-slate-200 dark:border-neutral-800">
