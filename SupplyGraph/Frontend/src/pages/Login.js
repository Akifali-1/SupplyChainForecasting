...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 dark:from-black dark:to-black flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <div className="inline-flex items-center space-x-2 bg-blue-100 dark:bg-neutral-900/90 px-4 py-2 rounded-full mb-4">
          ...
          <CardContent>
            ...
            <div className="mt-4">
              <Button
                ...
                className="w-full h-12 border-slate-300 dark:border-neutral-800 hover:bg-slate-50 dark:hover:bg-neutral-850 transition-colors rounded-lg"
              >
                Try Demo Account
              </Button>
            </div>
