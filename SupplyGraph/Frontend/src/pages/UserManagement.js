...
const UserManagement = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8 space-y-8 text-slate-800 dark:text-slate-100">
      {/* Header Banner */}
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center space-y-4 md:space-y-0 border-b border-slate-200 dark:border-slate-800 pb-6">
        <div>
        ...
        <div className="flex space-x-2">
          <Button 
            ...
            className="bg-slate-900 dark:bg-slate-100 hover:bg-slate-800 dark:hover:bg-slate-200 text-white dark:text-slate-950 flex items-center space-x-2 shadow-md transition-all duration-200"
          >
            {generatingInvite ? (
        ...
        <Card className="border border-indigo-500/30 bg-indigo-500/5 dark:bg-indigo-500/10 shadow-lg">
          ...
          <CardContent>
            <div className="flex flex-col sm:flex-row gap-3">
              <div className="flex-1 bg-white dark:bg-slate-950 px-4 py-3 rounded-lg border border-slate-200 dark:border-slate-800 font-mono text-sm break-all flex items-center select-all select-none">
                {inviteUrl}
              </div>
              <Button
                variant="outline"
      ...
      <Card className="border border-slate-200 dark:border-slate-800 shadow-md">
        ...
        <CardContent>
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center py-12 space-y-2 border-2 border-dashed border-slate-200 dark:border-slate-800 rounded-xl">
              ...
              <table className="min-w-full divide-y divide-slate-200 dark:divide-slate-800 text-left">
                ...
                <tbody className="divide-y divide-slate-100 dark:divide-slate-800 text-sm">
                  {members.map((member) => {
                    ...
                    return (
                      <tr key={member._id} className="hover:bg-slate-50/50 dark:hover:bg-slate-800/20 transition-colors">
                        <td className="py-4 px-4 font-semibold text-slate-900 dark:text-slate-100 flex items-center space-x-2">
                          <div className="w-8 h-8 rounded-full bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-xs font-bold font-mono">
