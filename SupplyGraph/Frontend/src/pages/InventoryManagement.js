...
const InventoryManagement = () => {
  ...
  const getTrendColor = (direction) => {
    switch (direction) {
      ...
      default:
        return 'bg-slate-100 text-slate-800 border-slate-200 dark:bg-neutral-850 dark:text-slate-300 dark:border-neutral-800';
    }
  };
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {summaryMetrics && (
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8 animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
            <Card className="shadow-lg border-0 bg-white/90 dark:bg-neutral-900/90 backdrop-blur-sm hover:shadow-xl transition-all duration-300">
        ...
        <Card className="shadow-2xl border-0 bg-white/90 dark:bg-neutral-900/90 backdrop-blur-sm animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
          <CardHeader className="bg-gradient-to-r from-purple-50 to-pink-50 dark:from-neutral-900 dark:to-neutral-900 rounded-t-lg">
            <CardTitle className="flex items-center space-x-2 text-slate-900 dark:text-white">
              ...
              <Badge className="bg-white/80 text-purple-700 border-purple-200 shadow-sm dark:bg-neutral-850 dark:text-purple-300 dark:border-green-800">
                {timeRange} Analysis
              </Badge>
            </CardTitle>
          </CardHeader>
        ...
        <div className="mt-8 text-center animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
          <div className="inline-flex items-center space-x-4 bg-white/80 dark:bg-neutral-900/80 backdrop-blur-sm px-6 py-3 rounded-full border border-blue-200 dark:border-neutral-800 shadow-lg">
