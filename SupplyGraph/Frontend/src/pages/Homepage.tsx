...
export const Homepage: React.FC = () => {
  ...
  const cardBackgrounds = CARD_BACKGROUNDS;
    ...
    switch (index) {
      case 0: // Demand Forecasting
        return (
          <svg className="w-full h-full min-h-[180px] max-h-[220px]" viewBox="0 0 300 180" fill="none">
            {/* Grid lines */}
            <line x1="10" y1="30" x2="290" y2="30" stroke="white" strokeOpacity="0.04" />
            <line x1="10" y1="75" x2="290" y2="75" stroke="white" strokeOpacity="0.04" />
            <line x1="10" y1="120" x2="290" y2="120" stroke="white" strokeOpacity="0.04" />
            <line x1="10" y1="160" x2="290" y2="160" stroke="white" strokeOpacity="0.08" />
            ...
            {/* Current Day marker */}
            <line x1="190" y1="10" x2="190" y2="160" stroke="white" strokeOpacity="0.3" strokeDasharray="3,3" />
      ...
      case 2: // Supplier Intelligence
        return (
          <svg className="w-full h-full min-h-[180px] max-h-[220px]" viewBox="0 0 300 180" fill="none">
            {/* Network Paths */}
            <path d="M 40 90 L 120 50 M 40 90 L 120 130 M 120 50 L 220 90 M 120 130 L 220 90 M 220 90 L 270 90" stroke="white" strokeOpacity="0.15" strokeWidth="2" />
            ...
            {/* Nodes */}
            <circle cx="40" cy="90" r="8" fill="#000000" stroke="white" strokeWidth="2" />
            <circle cx="120" cy="50" r="8" fill="#000000" stroke={accent} strokeWidth="2" />
            <circle cx="120" cy="130" r="8" fill="#000000" stroke="#F59E0B" strokeWidth="2" />
            <circle cx="120" cy="130" r="14" stroke="#F59E0B" strokeWidth="1.5" className="animate-pulse-glow" />
            <circle cx="220" cy="90" r="10" fill="#000000" stroke="white" strokeWidth="2" />
            <circle cx="270" cy="90" r="6" fill="#000000" stroke="white" strokeWidth="1.5" />
          </svg>
        );
      ...
      case 4: // Model Fine-Tuning
        return (
          <svg className="w-full h-full min-h-[180px] max-h-[220px]" viewBox="0 0 300 180" fill="none">
            {/* Layer 1: Left */}
            <circle cx="40" cy="50" r="5" fill="white" opacity="0.4" />
            <circle cx="40" cy="90" r="5" fill="white" opacity="0.4" />
            <circle cx="40" cy="130" r="5" fill="white" opacity="0.4" />
            ...
            <circle cx="200" cy="115" r="5" fill="white" opacity="0.8" />
            
            {/* Connections */}
            <line x1="45" y1="50" x2="115" y2="35" stroke="white" strokeOpacity="0.08" />
            <line x1="45" y1="50" x2="115" y2="70" stroke="white" strokeOpacity="0.08" />
            <line x1="45" y1="90" x2="115" y2="70" stroke="white" strokeOpacity="0.08" />
            <line x1="45" y1="90" x2="115" y2="110" stroke="white" strokeOpacity="0.08" />
            <line x1="45" y1="130" x2="115" y2="110" stroke="white" strokeOpacity="0.08" />
            <line x1="45" y1="130" x2="115" y2="145" stroke="white" strokeOpacity="0.08" />
  ...
  return (
    <main className="main-wrapper bg-[#000000] text-white min-h-screen relative w-full">
      
      {/* 1. HERO SECTION */}
      <section className="relative h-screen w-full flex flex-col justify-between overflow-hidden bg-[#000000] z-0">
        
        {/* Animated Particle Field */}
        <ParticleField />

        {/* Floating Capsule Navbar (Image 3 style) */}
        <div className="fixed top-6 left-0 right-0 w-full px-6 md:px-12 z-50 flex items-center justify-between pointer-events-none">
          ...
          <div className="pointer-events-auto flex items-center gap-2 bg-[#000000]/60 backdrop-blur-xl border border-white/10 rounded-full px-4 py-2 hover:border-white/20 transition-all duration-300 shadow-xl">
          ...
          <div className="pointer-events-auto flex items-center bg-[#000000]/65 backdrop-blur-xl border border-white/10 rounded-full p-1.5 pl-6 gap-6 md:gap-8 max-w-max shadow-2xl">
            {/* Nav links (Only shown if authenticated) */}
            {isAuthenticated && (
              <div className="hidden lg:flex items-center gap-6">
                <Link to="/dashboard" className="text-[#94A3B8] font-semibold text-[10px] uppercase tracking-widest hover:text-white transition-colors duration-200">
                  Dashboard
                </Link>
                <Link to="/prediction" className="text-[#94A3B8] font-semibold text-[10px] uppercase tracking-widest hover:text-white transition-colors duration-200">
                  Predictions
                </Link>
                <Link to="/inventory" className="text-[#94A3B8] font-semibold text-[10px] uppercase tracking-widest hover:text-white transition-colors duration-200">
                  Inventory
                </Link>
                ...
                {user?.role === 'admin' && (
                  <div className="relative">
                    <button 
                      ...
                      className="flex items-center gap-1 text-[#94A3B8] font-semibold text-[10px] uppercase tracking-widest hover:text-white transition-colors duration-200 focus:outline-none"
                    >
                      <span>Admin</span>
                      <ChevronDown className={`w-3 h-3 transition-transform duration-200 ${showAdminDropdown ? 'rotate-180' : ''}`} />
                    </button>
                    {showAdminDropdown && (
                      <div className="absolute top-8 left-0 w-44 bg-[#000000] border border-white/10 rounded-2xl p-1.5 shadow-2xl z-50">
                        <Link 
                          to="/upload" 
        ...
        {/* Hero Content (Positioned from center/slightly below center) following the Forecast AI font style */}
        <div className="absolute top-[42vh] md:top-[46vh] left-8 md:left-16 max-w-4xl z-10 select-none pr-8">
          <FadeIn delay={0.15} y={40}>
            <h1 
              className="text-white font-bold leading-[0.9] tracking-tighter"
          ...
          <FadeIn delay={0.3} y={40}>
            <h1 
              className="text-white font-bold leading-[0.9] tracking-tighter mt-4"
              style={{ fontSize: 'clamp(2.5rem, 6.5vw, 5.5rem)' }}
            >
              Demand Forecasting
            </h1>
        ...
        {/* 3D Spline Robot — Premium Dual-Layer Mount:
            (1) Layer 1: Pixel-perfect, watermark-cropped static WebP/PNG Visual Proxy
        ...
        >
          {isMobile ? (
            /* Mobile: no Spline at all — static placeholder, zero GPU cost */
            ...
            /* Desktop: Mount dual-layer system */
            <>
              ...
              >
                <div className="w-[380px] h-[580px] rounded-[40px] bg-gradient-to-b from-[#00B4D8]/12 via-[#7B2FBE]/6 to-transparent border border-white/[0.08] flex items-center justify-center relative overflow-hidden shadow-2xl shadow-cyan-500/5">
                  ...
                  <div className="absolute bottom-8 left-1/2 -translate-x-1/2 bg-black/60 backdrop-blur-md border border-white/10 px-4 py-2 rounded-full flex items-center gap-2">
                    ...
                    <span className="text-[10px] text-white/60 uppercase tracking-widest font-mono select-none">Booting WebGL...</span>
                  </div>
                </div>
              </div>
        ...
        <div className="absolute bottom-6 left-1/2 -translate-x-1/2 z-10 flex flex-col items-center gap-1.5 opacity-60">
          <div className="w-[24px] h-[40px] border-2 border-white/30 rounded-full flex justify-center pt-2">
            <div className="w-[6px] h-[10px] bg-white rounded-full scroll-dot" />
          </div>
        </div>
      ...
      <section 
        ...
        className="relative bg-[#000000] pt-32 pb-20 overflow-hidden w-full border-b border-white/[0.05]"
      >
        <div className="max-w-7xl mx-auto px-6 md:px-8">
          ...
          <FadeIn delay={0.1} y={30} className="text-center mt-4">
            <h2 
              className="text-white font-light tracking-[0.03em] uppercase leading-tight"
          ...
          <FadeIn delay={0.2} y={30} className="text-center mt-4 flex justify-center">
            <p className="text-[#64748B] font-light max-w-xl leading-relaxed text-sm">
          ...
          <div className="w-full overflow-hidden">
            <motion.div 
              ...
              style={{ 
                ...
                // GPU promotion — forces this layer onto the compositor
      ...
      <section 
        ...
        className="relative bg-[#000000] rounded-t-[50px] -mt-12 z-10 px-5 sm:px-8 md:px-10 py-24 border-t border-white/5"
      >
        <div className="max-w-7xl mx-auto mb-20">
          <FadeIn delay={0} y={40} className="text-center">
            ...
            <h2 
              className="cyan-heading font-black uppercase leading-tight mt-4"
        ...
        <div className="max-w-5xl mx-auto flex flex-col items-center">
          {serviceCards.map((service, index) => {
            return (
              ...
              >
                <div 
                  className="w-full rounded-[40px] sm:rounded-[50px] md:rounded-[60px] border-2 border-white/10 p-6 sm:p-8 md:p-10 flex flex-col justify-between shadow-2xl relative overflow-hidden transition-all duration-300 hover:border-white/20"
                  style={{ backgroundColor: cardBackgrounds[index] }}
                >
                  {/* Top Row: Header */}
                  <div className="flex items-center justify-between gap-4 w-full border-b border-white/5 pb-6 mb-6">
                    <div className="flex items-center gap-4 sm:gap-6">
                      <span className="font-black text-white leading-none text-5xl sm:text-6xl md:text-7xl select-none tracking-tighter">
                        {service.stage}
                      </span>
                      <div className="flex flex-col">
                        ...
                        <h3 className="text-white font-black uppercase text-base sm:text-lg md:text-xl tracking-wide mt-1">
                          {service.name}
                        </h3>
                      </div>
                    </div>
                    <Link 
                      to="/prediction"
                      className="border-2 hover:bg-[#D7E2EA]/10 text-white rounded-full px-4 py-1.5 sm:px-5 sm:py-2 text-[10px] sm:text-xs uppercase font-bold tracking-widest transition-all duration-300 whitespace-nowrap"
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 w-full items-stretch">
                    ...
                    <div className="lg:col-span-2 flex flex-col gap-4 justify-between">
                      {service.metrics.map((metric, mIdx) => (
                        <div 
                          key={mIdx}
                          className="flex-1 bg-white/[0.02] border border-white/[0.05] rounded-[20px] p-4 flex flex-col justify-between min-h-[90px] relative overflow-hidden group hover:bg-white/[0.04] transition-colors duration-300"
                        >
                          <div>
                            <span className="text-[10px] text-[#64748B] font-bold tracking-wider block">
                              {metric.label}
                            </span>
                            <span className="text-2xl sm:text-3xl font-black text-white block mt-1 tracking-tight">
                              {metric.value}
                            </span>
                          </div>
                    ...
                    <div className="lg:col-span-3 bg-white/[0.01] border border-white/[0.05] rounded-[24px] p-4 flex items-center justify-center min-h-[220px] relative overflow-hidden group hover:bg-white/[0.03] transition-colors duration-300">
                  ...
                  <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mt-6 pt-4 border-t border-white/5">
                    <p className="text-[#64748B] text-xs sm:text-sm font-light max-w-xl">
                      {service.description}
                    </p>
                    <div className="flex flex-wrap gap-1.5 self-end sm:self-center">
                      {service.tags.map((tag, tIdx) => (
                        <span 
                          key={tIdx}
                          className="bg-white/5 border border-white/10 text-[#94A3B8] text-[10px] rounded-full px-2.5 py-0.5 font-medium whitespace-nowrap"
                        >
                          {tag}
                        </span>
                      ))}
      ...
      {/* 4. FOOTER (Restored massive Forecast AI style) */}
      <footer className="py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden border-t border-white/5 bg-[#000000]">
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="flex flex-col">
            ...
            {/* Navigation Links */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-sm font-medium text-slate-400 w-full">
              {/* Left Column */}
